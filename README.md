# misima-anken — 株式会社Re:venge コーポレートサイト

**通信業界向けの販売支援・営業支援を行う BPO 企業**（株式会社Re:venge）のコーポレートサイト（静的サイト）です。
...
| 項目 | 内容 |
|---|---|
| 社名 | 株式会社Re:venge（Re:venge Co., Ltd. ／ かな：りべんじ） |
| 代表者 | 代表取締役社長　今別府 尭 |
...
> サイト表示の「Re:venge」はブランド表記。設立日・電話番号・従業員数等はサイト未掲載（確定後に反映）。
